...
export class TaskDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('clicktickApp.task.delete.question'));
...
export default class TaskComponentsPage {
  ...
  async deleteTask() {
    ...
    expect(await taskDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/clicktickApp.task.delete.question/);
