...
export class CustomerDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('clicktickApp.customer.delete.question'));
...
export default class CustomerComponentsPage {
  ...
  async deleteCustomer() {
    ...
    expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/clicktickApp.customer.delete.question/);
