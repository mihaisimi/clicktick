...
import com.startup.clicktick.domain.Task;
import com.startup.clicktick.repository.TaskRepository;
...
/**
 * REST controller for managing {@link com.startup.clicktick.domain.Task}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Task> result = taskRepository
            ...
            .map(existingTask -> {
                ...
                if (task.getExternalId() != null) {
                    existingTask.setExternalId(task.getExternalId());
                }
