...
import com.startup.clicktick.domain.Customer;
import com.startup.clicktick.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link com.startup.clicktick.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getEwalletAmmount() != null) {
                    existingCustomer.setEwalletAmmount(customer.getEwalletAmmount());
                }
                ...
                if (customer.getCountryCode() != null) {
                    existingCustomer.setCountryCode(customer.getCountryCode());
                }
