...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TASKSHEET_LIST actions', async () => {
    ...
    it('dispatches FETCH_TASKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TASKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TASKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TASKSHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TASKSHEET actions', async () => {
      const expectedActions = [
        {
